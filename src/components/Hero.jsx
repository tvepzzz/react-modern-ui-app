...
const Hero = () => (
	...
	>
		...
		>
			...
			<h1 className="font-poppins font-semibold ss:text-[68px] ss:leading-[100px] leading-[75px] text-[52px] text-white w-full">
				Payment Method.
			</h1>
		...
		>
			...
			<div className="absolute w-[80%] h-[80%] bottom-40 white__gradient z-[1]"></div>
			<div className="absolute w-[50%] h-[50%] right-20 bottom-20 blue__gradient z-[2]"></div>
		</div>
